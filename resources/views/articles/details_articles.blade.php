...
<body>
    ...
    <nav id="breadcrumbs" class="breadcrumbs">
        <div class="container page-wrapper">
            <a href="/articles/liste_articles">Accueil</a> / Blog / <span class="breadcrumb_last"
                aria-current="page">Détails articles</span>
        </div>
    </nav>
            ...
            <div class="blog-post-align">
                <div class="blog-post-img">
                    <a href="author.html"><img
                            src="https://i.pinimg.com/564x/79/42/1e/79421edd6375c1a47f98eaceff674e7f.jpg" alt=""
                ...
                <div class="blog-post-info">
                    ...
                    <ul class="blog-meta">
                        <li class="meta-item blog-lesson">
                            <span class="meta-value"> {{ $article->created_at->format('d/m/Y') }}</span>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="container pb-lg-4">
                <div class="single-post-image">
                    <div class="post-content">
                        <img src="/assets/images/blogsingle.jpg" class="radius-image img-fluid mb-5"
                            alt="" />
                    </div>
                </div>
                <div class="single-post-content">
                    ...
                    @endphp
                    <p class="alphabet mb-4"><span
                            class="big-letter">{{ $firstLetter }}</span>{{ substr($article->description, 1) }}</p>
                                ...
                                @foreach ($article->commentaires as $commentaire)
                                    <div class="author-card mt-5">
                                        <div class="row align-items-center">
                                            <div class="col-sm-3 col-6">
                                                <div>
                                                    <img src="https://i.pinimg.com/564x/84/57/31/8457318ae15f70e9d671abedc7f4c550.jpg"
                                                        alt="..." class="rounded-circle img-fluid">
                                                </div>
                                            </div>
                                            <div class="col-sm-9 mt-sm-0 mt-3">
                                                ...
                                                <ul class="author-icons mt-4">
                                                    <!-- Ici, vous pouvez ajouter les liens vers les réseaux sociaux si nécessaire -->
                                                </ul>
                                                <p>{{ $commentaire->contenu }}</p>
                                                <div class="action"
                                                    style="display: flex; align-items:center; justify-content:end; float: left; margin-top:10px">
                                                    <a href="/commentaires/modifier_commentaires/{{ $commentaire->id }}"
                                                        class="btn btn-info" style="margin-right:10px; "><i
                                                            class="fas fa-edit"></i> </a>
                                                    <a href="/commentaires/supprimer/{{ $commentaire->id }}"
                    ...
                    <div class="container">
                        ...
                        <div class="leave-comment-form mt-5" id="reply">
                            ...
                            <form action="/articles/{{ $article->id }}/details_articles/commentaires/traitement"
                                method="POST">
                                @csrf
                                <div class="input-grids row">
                                    <div class="col-6">
                                        ...
                                        <div class="form-group">
                                            <textarea name="contenu" class="form-control" placeholder="Votre commentaire*" required="" spellcheck="false"></textarea>
                                        </div>
                                    </div>
                                </div>
