...
<body>
    <div class="ajouter mb-3">
        <a href="/articles/ajouter_articles" class="btn btn-success"><i class="fas fa-plus-circle"></i> Ajouter un article</a>
    </div>
   <div class="container">
                   ...
                   <div class="card h-100">
                       ...
                       <div class="card-body">
                           ...
                           <div class="d-flex justify-content-between align-articles-center ">
                                ...
                                <a href="/commentaires/liste_commentaires/{{$article->id}}" class="btn btn-primary"><i class="fas fa-comments"></i> </a>
                            </div>
                         </div>
                   </div>
               </div>
